...
def main():
    ...
    try:
        ...
        # 1. AJUSTE: O setup do logger agora retorna o caminho do log da execução atual
    ...
    try:
        ...
        # 2. AJUSTE: A função de processamento agora também retorna o relatório de etapas
        (df_humano, df_robo), process_report = processar_dados(all_dataframes, config)
        ...
        # 3. AJUSTE: Passa o caminho do log da execução para o compressor
        organize_and_compress_output(config, run_log_file)
        logging.info("--- ESTÁGIO 5 CONCLUÍDO ---")
        
        # Salva o estado e as métricas para a próxima execução
